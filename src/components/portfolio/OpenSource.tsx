              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-5">
                    Submitted a Pull Request to an open source repository on
                    GitHub — actively engaging with the open source community as
                    a new contributor. Reviewing the project codebase and issue
                    tracker to identify meaningful contributions as task
                    assignments come through.
                  </p>
            ...
            >
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-5">
                    Contributing to an open source frontend project by
                    identifying and fixing bugs. Debugged issues, implemented
                    fixes, and collaborated with the community to improve code
